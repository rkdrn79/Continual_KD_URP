...
class Appr(Inc_Learning_Appr):
    ...
    def __init__(self, model, device, nepochs=60, lr=0.5, lr_min=1e-4, lr_factor=3, lr_patience=5, clipgrad=10000,
                 ...
                 eval_on_train=False, logger=None, exemplars_dataset=None, erf_approach = None, rgr_approach = None, erf_m = 1, rgr_m = 1, cycle_approach = 'all', distill_percent = 0.2,  lamb=1):
